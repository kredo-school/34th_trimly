            ...
            <div class="col-12 col-md-10 col-lg-8">
                <div class="register-container" style="max-width: 800px; width: 90%; margin: auto;">
                    ...
                    <div class="card p-4 mb-4 shadow-sm">
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3 fw-bold text-muted"><i class="fa-solid fa-user me-2"></i>Pet Owner Information</h4>
                            ...
                            <form action="#" method="post"> 
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="firstName" class="form-label text-muted">First Name <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="lastName" class="form-label text-muted">Last Name <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-custom">
                                            <span class="input-group-text input-group-text-custom">
                                                <i class="fa-solid fa-user"></i>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="emailAddress" class="form-label text-muted">Email Address <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-custom">
                                            <span class="input-group-text input-group-text-custom">
                                    ...
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="phoneNumber" class="form-label text-muted">Phone Number <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-custom">
                                            <span class="input-group-text input-group-text-custom">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="prefecture" class="form-label text-muted">Prefecture <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-custom">
                                            <span class="input-group-text input-group-text-custom">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="confirmPassword" class="form-label text-muted">Confirm Password <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-custom">
                                            <span class="input-group-text input-group-text-custom">
                                                <i class="fa-solid fa-lock"></i>
                                            </span>
                                            <input type="password" class="form-control" id="confirmPassword" placeholder="Confirm password" required>
                                            <span class="input-group-text input-group-text-custom toggle-password" data-target="confirmPassword">
                                                <i class="fa-solid fa-eye-slash"></i>
                                            </span>
                                        </div>
                                    </div>
