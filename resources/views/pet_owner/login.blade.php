...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            box-shadow: 0 0 0 0.25rem rgba(240, 195, 142, 0.25);
            /*フォーカスシャドウの色をボタンカラーに合わせる */
            border-color: #FEFCF1;
            /*フォーカス時のボーダー色をボタンカラーに合わせる */
        }
                ...
                <div class="login-container text-center">
                    ...
                    <div class="bg-white shadow-sm rounded-5 p-4">
                        ...
                        <form action="#" method="post">
                            ...
                            <button type="button" class="btn btn-outline-secondary w-100 mb-3">For Salons - Sign
                                In</button>
                            <p class="text-muted">New Salon? <a href="#" class="text-decoration-none">Register
                                    Here</a></p>
                        </form>
                    </div>
                </div>
