                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="petName" id="petName"
                                                class="form-control form-control-inline" value="John"
                                                autofocus>{{-- DBからのデータ表示 --}}
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Breed</label>
                                            <input type="text" name="breed1" id="breed"
                                                class="form-control form-control-inline" value="Smith"
                                                autofocus>{{-- DBからのデータ表示 --}}
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Age</label>
                                            <select name="age" id="age"
                                                class="form-select form-control-inline-select">
